...
const styles = StyleSheet.create({
  ...
  header: {
    backgroundColor: '#0066cc', borderBottomWidth: 0, elevation: 4,
    shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 4,
  },
  headerContent: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 8, height: 56 },
  headerLeft: { alignItems: 'flex-start', width: 48 },
  headerCenter: { flex: 1, alignItems: 'center' },
  headerRight: { alignItems: 'flex-end', width: 48 },
  ...
  tabletSidebar: { width: 250, backgroundColor: '#ffffff', borderRightWidth: 1, borderRightColor: '#e0e0e0', paddingTop: 20, alignItems: 'center' },
  tabletSidebarText: { fontSize: 16, color: '#666' },
  tabletContent: { flex: 1, padding: 20 },
});