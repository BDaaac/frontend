      ...
      <ScrollView>
        <View style={styles.section}>
          ...
          <View style={styles.sectionContent}>
            <SettingRow label="Edit Profile" onPress={() => navigation.navigate('Profile', { userId: '123' })} showArrow />
            <SettingRow label="Change Password" onPress={() => Alert.alert('Change Password')} showArrow />
            <SettingRow label="Privacy" onPress={() => Alert.alert('Privacy Settings')} showArrow />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.sectionContent}>
            <SettingRow label="Push Notifications" description="Receive notifications about activity" value={notifications} onValueChange={setNotifications} />
            <SettingRow label="Dark Mode" description="Use dark theme" value={darkMode} onValueChange={setDarkMode} />
            <SettingRow label="Auto-play Videos" description="Play videos automatically" value={autoPlay} onValueChange={setAutoPlay} />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.sectionContent}>
            <SettingRow label="Analytics" description="Help improve the app" value={analytics} onValueChange={setAnalytics} />
            <SettingRow label="Clear Cache" onPress={() => Alert.alert('Cache cleared')} showArrow />
          </View>
        </View>
